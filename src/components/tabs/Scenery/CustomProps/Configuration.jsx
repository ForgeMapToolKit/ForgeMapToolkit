...
export default function CustomPropsConfiguration({ mapName, setMapName, mapInfo }) {
  const [metaOpen, setMetaOpen] = useState(false);

  const finalMapName = mapName?.trim()
    ? (mapName.trim().match(/\.v\d{4}$/) ? mapName.trim() : mapName.trim() + '.v0001')
    : '';
