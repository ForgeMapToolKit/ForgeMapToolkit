...
const SECTIONS = [
  ...
  { id: 'export',      index: '05', label: 'Export',       desc: 'Format, README generation, decimal precision and post-export actions.' },
  { id: 'performance', index: '06', label: 'Performance',  desc: 'Worker threads, DDS cache, library scan policy and hardware acceleration.' },
  { id: 'developer',   index: '07', label: 'Developer',    desc: 'Log level, verbose IPC, log viewer, DevTools and factory reset.' },
  { id: 'donations',   index: '08', label: 'Donations',    desc: 'Support the development of ForgeMapToolkit — PayPal, GitHub, Patreon, Ko-fi.' },
];
