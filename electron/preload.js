...
const INVOKE_CHANNELS = new Set([
  ...
  'node-editor-list-projects',
  'node-editor-create-project',
  'node-editor-load-project',
  'node-editor-save-graph',
  'node-editor-delete-graph',
  'viewer3d-load-mesh',
